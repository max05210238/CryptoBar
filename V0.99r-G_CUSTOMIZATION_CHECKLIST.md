...
```cpp
// FROM (V0.99r):
// V0.99r: Default update interval: 3 minutes
static const uint32_t UPDATE_INTERVAL_MS = 3UL * 60UL * 1000UL;  // 3 minutes
...
| **Resolution** | 296×128 (landscape) | 296×128 (landscape) |
| **Colors** | Black/White/Red (3-color) | Black/White/Red/Yellow (4-color) |
| **Partial Refresh** | ✅ Supported | ❌ NOT supported |
...
| **Buffer Size** | Auto-calculated | 9,472 bytes (128/4 × 296) |
...
- [ ] Full screen renders correctly (296×128, 4 colors)
