...
// Mirror of firmware presets (keep in sync with main.cpp).
static const int kUpdPresetCount = 4;
static const int kUpdPresetSecs[kUpdPresetCount] = {30, 60, 180, 300};
static const char* kUpdPresetLabels[kUpdPresetCount] = {"30s", "60s", "3m", "5m"};
